...
if (hasRun == false || hasRun == undefined || hasRun == null) {
    ...
    /* Set "hasRun" to true, stops it from running again  */
    hasRun = true;

    // Add arrays and variable to sessionStorage, will now be available on any page of website
...
function createGoToCart() {
    ...
    /* create button that says "Go to cart" | couldnt get this to work */
    if (selectButtonDiv) {
        ...
        /* Add event listener | click to go to cart */
...
/* Add delivery cost, subtract coupon discount */
function addDeliveryInfo() {
    ...
    if (selectShippingButton) {
        ...
        // Change selection from string to number
